...
var markers = L.markerClusterGroup({
  iconCreateFunction: function(cluster) {
    ...
    var clusterHtml = `<div class="cluster-icon-container" style="position: relative;">
                         ...
                         <div class="cluster-number" style="background: rgba(255, 0, 0, 0.6); border-radius: 50%; color: white; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">
         ...
         var customIcon = L.divIcon({
          html: `
            <div class="custom-icon-container">
              ...
              ${station.promotions.length > 0 ? '<div class="red-dot animate"></div>' : ''}
            </div>
          `,
            className: '',
...
function getPromotionImageUrl_MARKER(item) {
  const promotionImages = {
    ...
    "promotion opening 1":
      "https://raw.githubusercontent.com/pttpos/map_ptt/main/pictures/promotion/promotion_opening_1.jpg",
    "promotion opening 2":
      "https://raw.githubusercontent.com/pttpos/map_ptt/main/pictures/promotion/promotion_opening_2.jpg",
    "promotion opening 3":
      "https://raw.githubusercontent.com/pttpos/map_ptt/main/pictures/promotion/promotion_opening_3.jpg",
    "promotion opening 4":
      "https://raw.githubusercontent.com/pttpos/map_ptt/main/pictures/promotion/promotion_opening_4.jpg",
